...
public class Home {
   ...
   private By getButton= By.xpath("//button[text()='Get Started']");
   private By homeTitle=By.xpath("//a[@class='navbar-brand']");
   private By dataStructureGet=By.xpath("/html/body/div[2]/div[1]/div/div/a");
   ...
   private By treeGet=By.xpath("/html/body/div[2]/div[6]/div/div/a");
   ...
   private By successLogOut=By.xpath("/html/body/div[2]");
    ...
    public void clickGetStarted() {
        elementsUtil.doClick(getButton);
    	
    }
    public String titleNumby()
    {
    	 return elementsUtil.doGetText(homeTitle);
    }

   
    public void clickDataGet()
    {
    	elementsUtil.doClick(dataStructureGet);
    }
    ...
    public void clickTreeGet()
    {
    	elementsUtil.doClick(treeGet);
    }
